...
var MyRefresh = requireNativeComponent('SJRefreshControl');

export default class ZmRefresh extends Component {
...
AppRegistry.registerComponent('ZmRefresh', () => ZmRefresh);
